...
i=1
echo
echo "+OCN-Automation Started - All the OCN Servers are included [Stage & Production]"
...
serverfile=/home/${current_username}/ocn-servers
servernamefile=/home/${current_username}/ocn-servers-names
filename=$serverfile
...
# Check if servers file is available in home directory
[ ! -f "/home/${current_username}/ocn-servers" ] && echo "ocn-servers file DOES NOT exists." && exit
[ ! -f "/home/${current_username}/ocn-servers-names" ] && echo "ocn-servers-name file DOES NOT exists." && exit
echo "+Collecting available servers..."
# display the available server list
echo "----------Available Servers------------------------------"
pr -tm -w 50 $servernamefile $serverfile
echo "---------------------------------------------------------"
...
while read line; do
    sleep 30
    echo
    currentservername=$(cat $servernamefile | sed -n $i'p')
